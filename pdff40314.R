...
summary(lm(FRPDFF~rs738409+rs58542926+rs429358+rs188247550+rs28601761+rs7096937+rs1260326+rs2642438+rs1229984+rs79905393+rs62226381,
           data = pdff))
##R2 = 4.8%
pdff <- pdff %>% mutate(
  HFCGRS=rs58542926*0.3080+rs188247550*0.2825+rs738409*0.2375+rs1229984*0.1673+rs2642438*0.0604+rs62226381*0.0547
